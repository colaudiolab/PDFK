...
class Parser:
    ...
    def __init__(self):
        ...
        parser.add_argument("--save-ckpt", action='store_true', help="whether to save checkpoints or not")
        ...
        parser.add_argument('--tf-type', default="full", choices=['full', 'partial', 'gsa'],
        ...
        parser.add_argument("--min-mix", type=float, default=0.5,
                            help="Min proportion of the original image to keep when using mixup or cutmix.")
        parser.add_argument("--max-mix", type=float, default=1.0,
                            help="Max proportion of the original image to keep when using mixup or cutmix.")
        ...
        parser.add_argument('--gen-strat', help="Artificial data generation strategy for GML. Choices=[neg, pos, all]",
                            default=None)
        ...
        parser.add_argument('--self-kd-alpha', type=float, default=1)
        parser.add_argument('--ce-beta', type=float, default=0.01)
        ...
        parser.add_argument('--kd-scheduler', action='store_true',
                            help="schedule the strenght of the distillation over time.")
        parser.add_argument('--vanilla-beta', action='store_true', help='Use regular probabilities as beta')
        parser.add_argument('--ema', action='store_true')
        parser.add_argument('--group-selection', default="all",
                            help="How to selct differents groups of labels for sep CE and KL.")
        ...
        # kfr arguments
        parser.add_argument('--kfr-enable', default=False,
                            help='Enable online KFR/RHL evaluation (default: False)')
        parser.add_argument('--kfr-eval-interval', type=int, default=20,
                            help='Evaluate every N optimizer steps')
        parser.add_argument('--kfr-k', type=str, default='50,100',
                            help='Comma-separated K values for KFR, e.g., "50,100"')
        parser.add_argument('--kfr-probe-batch-size', type=int, default=256,
                            help='Batch size for probe (evaluation) DataLoader')

        # parser.add_argument('--perturb', action="store_true")
        parser.add_argument('--p-steps', type=int, default=1, help="Number of perturbation steps")
        parser.add_argument('--p-lam', type=float, default=0.1, help="Loss weight for perturbation KL")
        parser.add_argument('--p-gamma', type=float, default=0.01, help="Perturbation learning rate scale")
